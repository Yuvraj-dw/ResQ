      ...
      {!isOnline && (
        <View style={styles.offlineBanner}>
          <Text style={styles.offlineText}>
            📡 You are offline. Emergency requests will be sent via SMS.
          </Text>
        </View>
      )}
            ...
            >
              <View style={styles.emergencyCardHeader}>
                <Badge
                  ...
                  variant={getEmergencyTypeVariant(emergency.type)}
                  size="sm"
                />
                <Badge
              ...
              <View style={styles.emergencyCardFooter}>
                ...
                <Text style={styles.emergencyTime}>⏱️ {emergency.timeAgo}</Text>
              </View>
            </TouchableOpacity>
          ))
        )}
